    ...
    <Layout.Content style={{ minHeight: '86vh', position: 'relative', padding: '30px 20px' }}>
      <Row gutter={16}>
        <Col lg={{ span: 16, offset: 4 }} md={{ span: 18, offset: 2 }} span={24}>
          ...
          <p>Your privacy is important to us. It is server.log()&#39;s policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, <a href="https://serverlog.vercel.app">https://serverlog.vercel.app</a>, and other sites we own and operate. </p>
          <p>This policy is effective as of 30 August 2021 and was last updated on 1 August 2021. </p>
          ...
          <p>M Gilang Januar<br />
          mgilangjanuar@gmail.com </p>
        </Col>
      </Row>
    </Layout.Content>
    <Footer />
